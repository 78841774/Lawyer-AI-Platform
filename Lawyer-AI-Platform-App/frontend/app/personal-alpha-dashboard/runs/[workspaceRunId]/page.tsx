  ...
  return (
    <AppShell>
      <div className="space-y-6">
        ...
        <Link href={`/personal-alpha-final-readiness?workspace_run_id=${encodeURIComponent(workspaceRunId)}`} className="ml-3 inline-flex rounded-md border border-line bg-white px-3 py-2 text-sm text-ink">
