...
RUNTIME_DEFINITIONS = [
    ...
    ("skill_package_versioning_runtime", "Skill Package Versioning & System Validation Gate", "skill", "/personal-skill-studio/training-artifacts"),
    ("internal_training_experience_package_runtime", "Internal Training / Experience Package Builder", "skill", "/personal-skill-studio/training-artifacts"),
    ("practice_load_review_runtime", "Practice Runtime Load Review Gate", "skill", "/personal-skill-studio/training-artifacts"),
