...
RUNTIME_ROOT = Path(__file__).resolve().parents[1] / "storage" / "runtime" / "personal_material_runtime"
PARSE_JOBS_DIR = RUNTIME_ROOT / "parse_jobs"
OCR_JOBS_DIR = RUNTIME_ROOT / "ocr_jobs"
