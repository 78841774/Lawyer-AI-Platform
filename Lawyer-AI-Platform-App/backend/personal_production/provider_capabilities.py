...
PROVIDER_DEFINITIONS = [
    ...
    ("skill_package_versioning_provider", "Skill Package Versioning & System Validation Gate", "skill_training", "skill_package_versioning_system_validation_metadata_ready", "/personal-skill-studio/training-artifacts", True),
    ("internal_training_experience_package_provider", "Internal Training / Experience Package Builder", "skill_training", "internal_training_experience_package_metadata_ready", "/personal-skill-studio/training-artifacts", True),
    ("practice_load_review_provider", "Practice Runtime Load Review Gate", "skill_training", "practice_load_review_gate_metadata_ready", "/personal-skill-studio/training-artifacts", True),
]
...
def build_provider_capabilities() -> dict:
    ...
    return PersonalProductionProviderCapabilities(
        ...
        skill_package_versioning_status="skill_package_versioning_system_validation_metadata_ready",
        internal_training_experience_package_status="internal_training_experience_package_metadata_ready",
        practice_load_review_status="practice_load_review_gate_metadata_ready",
        ...
        skill_package_versioning_ready=True,
        skill_package_manifest_ready=True,
        skill_package_source_trace_ready=True,
        skill_package_audit_ready=True,
        skill_package_system_validation_gate_ready=True,
        skill_package_final_review_not_applicable=True,
        skill_package_provider_call_disabled=True,
        skill_package_raw_content_blocked=True,
        skill_package_api_key_read_disabled=True,
        skill_package_training_disabled=True,
        skill_package_publish_disabled=True,
        internal_training_experience_package_ready=True,
        internal_training_task_builder_ready=True,
        internal_experience_package_builder_ready=True,
        internal_training_pending_practice_review_ready=True,
        internal_training_provider_call_disabled=True,
        internal_training_api_key_read_disabled=True,
        internal_training_real_training_disabled=True,
        internal_training_skill_publish_disabled=True,
        practice_load_review_gate_ready=True,
        lawyer_experience_editor_ready=True,
        practice_load_revalidation_ready=True,
        practice_load_lawyer_approval_required=True,
        practice_load_provider_call_disabled=True,
        practice_load_api_key_read_disabled=True,
        practice_load_real_training_disabled=True,
        practice_load_skill_publish_disabled=True,
        practice_runtime_loading_deferred_to_v731g=True,
        ...
        warnings=[
            ...
            "Skill Package Versioning: v7.31d packages confirmed Skill draft metadata and runs system validation without provider calls, real training, or Skill publishing.",
            "Internal Training Package Builder: v7.31e builds internal training tasks and experience packages from system-validated package metadata only, then marks them pending practice load review.",
            "Practice Load Review Gate: v7.31f lets lawyers edit and approve experience package metadata before future practice runtime loading; no runtime load is executed.",
