...
- v8.x Team Workspace.
- v9.x External Client Delivery / Public Promotion Version.

## Current Priority

Personal production validation and showcase readiness come before team edition and external client delivery.
