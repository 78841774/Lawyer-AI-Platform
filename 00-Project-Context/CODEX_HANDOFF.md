...
- Active local worktree scope: v7.25-v7.29 are implemented locally and awaiting user-confirmed continuation, validation, or release handling. Future Codex work must treat v7.27-v7.29 as implemented facts, not planned next tasks.
...
Continue to v7.31d Skill Package Versioning & Pre-Publish Gate, or run v7.31b-v7.31c validation / release preparation only after explicit user confirmation. Do not treat v7.27 as the next task. Do not repeat the v7.27 OCR / Document, v7.28 unified live dashboard, v7.29 Legal / Enterprise gateway, v7.30 loader, v7.31 closed-case training run, v7.31a intake/redaction, v7.31b experience candidate pipeline, or v7.31c experience pool/draft builder implementations. Do not start Team Workspace or External Client Delivery until the user explicitly confirms the next development direction.

v7.31d scope should use only v7.31c non-publishable draft metadata and add package versioning / pre-publish gate metadata without publishing Skills.
