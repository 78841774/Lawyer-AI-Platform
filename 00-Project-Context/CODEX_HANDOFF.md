...
Continue to v7.31b Codex Training on Real Closed Cases, or run v7.25-v7.31a validation / release preparation only after explicit user confirmation. Do not treat v7.27 as the next task. Do not repeat the v7.27 OCR / Document, v7.28 unified live dashboard, v7.29 Legal / Enterprise gateway, v7.30 loader, v7.31 closed-case training run, or v7.31a intake/redaction implementations. Do not start Team Workspace or External Client Delivery until the user explicitly confirms the next development direction.

v7.31b scope should use only v7.31a-authorized and redacted real closed-case training metadata. Codex training remains metadata artifact generation/loading, not model-parameter fine-tuning.
